...
void train_model(int digit, int utterance){
	...
	FILE *fp;
	char filenameA[40];
	//_snprintf(filenameA,40,"234101053_lambda/A_%d_%d.txt",digit,utterance);
	_snprintf(filenameA,40,"234101053_lambda/A_%d_%d.txt",digit,utterance);
	...
	//Store B in file
	char filenameB[40];
	//_snprintf(filenameB,40,"234101053_lambda/B_%d_%d.txt",digit,utterance);
	_snprintf(filenameB,40,"234101053_lambda/B_%d_%d.txt",digit,utterance);
...
void calculate_avg_model_param(int d){
	...
	for(int u=1;u<=25;u++){
		char filenameA[40];
		//_snprintf(filenameA,40,"234101053_lambda/A_%d_%d.txt",d,u);
		_snprintf(filenameA,40,"234101053_lambda/A_%d_%d.txt",d,u);
		fp=fopen(filenameA,"r");
		for (int i = 1; i <= N; i++)
		{
		...
		fclose(fp);
		char filenameB[40];
		//_snprintf(filenameB,40,"234101053_lambda/B_%d_%d.txt",d,u);
		_snprintf(filenameB,40,"234101053_lambda/B_%d_%d.txt",d,u);
		fp=fopen(filenameB,"r");
		for (int i = 1; i <= N; i++)
		{
...
void store_final_lambda(int digit){
	FILE *fp;
	char filenameA[40];
	//_snprintf(filenameA,40,"234101053_lambda/A_%d.txt",digit);
	_snprintf(filenameA,40,"234101053_lambda/A_%d.txt",digit);
	fp=fopen(filenameA,"w");
	for (int i = 1; i <= N; i++)
	{
	...
	fclose(fp);
	char filenameB[40];
	//_snprintf(filenameB,40,"234101053_lambda/B_%d.txt",digit);
	_snprintf(filenameB,40,"234101053_lambda/B_%d.txt",digit);
	fp=fopen(filenameB,"w");
	for (int i = 1; i <= N; i++)
	{
...
void processTestFile(int d){
	...
	initialization();
	char filenameA[40];
	//_snprintf(filenameA,40,"234101053_lambda/A_%d.txt",d);
	_snprintf(filenameA,40,"234101053_lambda/A_%d.txt",d);
	fp=fopen(filenameA,"r");
	if (fp == NULL){
		printf("Error\n");
	...
	char filenameB[40];
	//_snprintf(filenameB,40,"234101053_lambda/B_%d.txt",d);
	_snprintf(filenameB,40,"234101053_lambda/B_%d.txt",d);
	fp=fopen(filenameB,"r");
	for (int i = 1; i <= N; i++){
		for (int j = 1; j <= M; j++){
...
void test_HMM(){
	...
	for(int d=0;d<=9;d++){
		for(int u=21;u<=30;u++){
			char filename[40];
			//_snprintf(filename,40,"dataset/234101053_E_%d_%d.txt",d,u);
			_snprintf(filename,40,"234101053_dataset/234101053_E_%d_%d.txt",d,u);
			generate_observation_sequence(filename);
			printf("Digit=%d\n",d);
